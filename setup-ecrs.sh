...
docker tag ha-app-application-tier:v1.0 $ECR_APPLICATION_TIER_REPO:v1.0

echo "################### Pushing application tier image ###################"
docker push $ECR_APPLICATION_TIER_REPO:v1.0
...
docker tag ha-app-presentation-tier:v1.0 $ECR_PRESENTATION_TIER_REPO:v1.0

echo "################### Pushing presentation tier image ###################"
docker push $ECR_PRESENTATION_TIER_REPO:v1.0
